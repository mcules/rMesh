...
const I18N = {
    en: {
        ...
        'setup.section_mesh': 'Mesh',
        'setup.max_hop_msg': 'Max Hops Messages:', 'setup.max_hop_pos': 'Max Hops Position:',
        'setup.max_hop_tel': 'Max Hops Telemetry:',
        ...
        'net.ntp': 'NTP Server:',
        'net.wifi_enabled': 'WiFi:',
        'net.wifi_tx_power': 'WiFi TX Power:',
        'net.bluetooth': 'Bluetooth', 'net.bt_mode': 'Mode:',
        'net.bt_off': 'Off', 'net.bt_coex': 'WiFi + BLE', 'net.bt_exclusive': 'BLE exclusive',
        'net.ethernet': 'Ethernet (LAN)', 'net.eth_enabled': 'Ethernet:',
        'net.eth_status': 'Status:', 'net.eth_connected': 'Connected', 'net.eth_no_link': 'No link',
        'net.general': 'General',
        'net.mesh_services': 'Mesh Services',
        'net.primary_iface': 'Primary Interface:',
        'net.primary_auto': 'Automatic',
        'net.node_comm': 'Node Communication:',
        'net.wifi_node_comm': 'WiFi Node Communication:',
        'net.wifi_webui': 'WiFi WebUI:',
        'net.eth_node_comm': 'LAN Node Communication:',
        'net.eth_webui': 'LAN WebUI:',
    ...
    de: {
        ...
        'setup.section_mesh': 'Mesh',
        'setup.max_hop_msg': 'Max Hops Nachrichten:', 'setup.max_hop_pos': 'Max Hops Position:',
        'setup.max_hop_tel': 'Max Hops Telemetrie:',
        'setup.section_system': 'System',
        ...
        'net.bluetooth': 'Bluetooth', 'net.bt_mode': 'Modus:',
        'net.bt_off': 'Aus', 'net.bt_coex': 'WiFi + BLE', 'net.bt_exclusive': 'BLE exklusiv',
        'net.ethernet': 'Ethernet (LAN)', 'net.eth_enabled': 'Ethernet:',
        'net.eth_status': 'Status:', 'net.eth_connected': 'Verbunden', 'net.eth_no_link': 'Kein Link',
        'net.general': 'Allgemein',
        'net.mesh_services': 'Mesh-Dienste',
        'net.primary_iface': 'Primäres Interface:',
        'net.primary_auto': 'Automatisch',
        'net.node_comm': 'Node-Kommunikation:',
        'net.wifi_node_comm': 'WiFi Node-Kommunikation:',
        'net.wifi_webui': 'WiFi WebUI:',
        'net.eth_node_comm': 'LAN Node-Kommunikation:',
        'net.eth_webui': 'LAN WebUI:',
