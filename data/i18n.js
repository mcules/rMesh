...
const I18N = {
    en: {
        ...
        'lora.min_snr': 'Min. SNR (dB):', 'lora.snr_off': 'Off (disabled)',
        ...
        'setup.section_oled': 'OLED Display', 'setup.oled_enabled': 'Display enabled:',
        'setup.oled_group': 'Message group:',
        'setup.oled_page_interval': 'Page interval (s):',
        'setup.oled_pages': 'Pages:',
        'setup.oled_button_pin': 'Button GPIO:',
        'setup.oled_button_pin_hint': '(-1 = off, active-low)',
        'setup.section_system': 'System',
        'setup.language': 'Language:',
        'setup.chat_fontsize': 'Chat font size:',
        'setup.cpu_frequency': 'CPU Frequency:',
        'setup.section_debug': 'Debug',
        'setup.serial_debug': 'Serial Debug:',
        'setup.heap_debug': 'Heap Debug:',
        // Network
        ...
        'btn.scan': 'scan', 'btn.add_from_scan': '+ Add', 'btn.add_wifi': '+ Network',
        'btn.check_install': 'check & install',
    ...
    de: {
        ...
        'lora.min_snr': 'Min. SNR (dB):', 'lora.snr_off': 'Aus (deaktiviert)',
        ...
        'setup.section_oled': 'OLED-Display', 'setup.oled_enabled': 'Display aktiviert:',
        'setup.oled_group': 'Nachrichten-Gruppe:',
        'setup.oled_page_interval': 'Seitenwechsel (s):',
        'setup.oled_pages': 'Seiten:',
        'setup.oled_button_pin': 'Taster-GPIO:',
        'setup.oled_button_pin_hint': '(-1 = aus, active-low)',
        'setup.section_system': 'System',
        ...
        'btn.check_install': 'Prüfen & installieren',
        'btn.force_install': 'Update erzwingen', 'btn.upload_flash': 'Hochladen & installieren',
